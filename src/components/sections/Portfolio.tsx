...
const cases = [
  { niche:'Шкафы автоматики',    tag:'Под ключ',  result:'Сайт-каталог продукции и запуск рекламы в Яндекс Директ для B2B-продаж.',    price:'Стоимость: от 280 000 ₽', img: '/projects/project1.png' },
  { niche:'Обработка участков',   tag:'Сайт',      result:'Промо-сайт услуг дезинфекции и сезонная рекламная кампания в регионе.', price:'Стоимость: от 175 000 ₽', img: '/projects/project2.png' },
  { niche:'Аварийный клининг',    tag:'Реклама',   result:'Настройка контекстной рекламы Яндекс Директ для привлечения срочных заказов.', price:'Ведение: от 42 000 ₽/мес', img: '/projects/project3.png' },
  { niche:'Диспетчеризация вентиляции', tag:'Лендинг', result:'Презентационный лендинг для сложного инженерного решения по автоматизации.', price:'Стоимость: от 65 000 ₽', img: '/projects/project4.png' },
]
