...
const cases = [
  ...
  { niche:'Диспетчеризация вентиляции', tag:'Лендинг', result:'Презентационный лендинг для сложного инженерного решения по автоматизации.', price:'Стоимость сайта: от 115 000 ₽', img: '/projects/project4.webp' },
]
