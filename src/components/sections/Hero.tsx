...
const workSlides = [
  ...
  { text: 'На связи каждый день. Составляем еженедельные понятные отчёты о количестве и стоимости целевых заявок (CPL).', category: 'О коммуникации' },
  { text: 'Не бросаем проекты после сдачи. Сопровождаем, делаем доработки и помогаем расти.', category: 'О поддержке' },
  { text: 'Фиксируем в договоре сроки, финальную стоимость и financial-гарантии.', category: 'О договоре' },
]
