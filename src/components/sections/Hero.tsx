...
const workSlides = [
  ...
  { text: 'На связи каждый день. Раз в неделю присылаем понятный отчёт: сколько заявок пришло и по какой цене.', category: 'О коммуникации' },
  { text: 'После сдачи проекта не пропадаем. Помогаем с доработками и отвечаем на вопросы.', category: 'О поддержке' },
  { text: 'Сроки, стоимость и условия фиксируем в договоре до начала работы.', category: 'О договоре' },
  { text: 'Домен — от 200 ₽/год. Хостинг — от 510 ₽/мес. Сайт не требует дорогого обслуживания — вы платите только за инфраструктуру.', category: 'О владении сайтом' },
  { text: 'Работаем с рекламными бюджетами от 30 000 ₽/мес. Меньше — алгоритмы не успевают обучиться и реклама не выходит в плюс.', category: 'О бюджете рекламы' },
]
      ...
      >
        ...
        <div className="hero-card-white" style={{
          ...
          <p style={{ fontFamily: 'var(--ff-b)', fontWeight: 400, fontSize: '12px', color: '#888', lineHeight: 1.7 }}>
            Предприниматели приходят с разными задачами — мы помогаем каждому выйти онлайн и запустить стабильный поток заявок.
          </p>
        </div>
