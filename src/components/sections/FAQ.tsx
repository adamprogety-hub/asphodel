...
const faqs = [
  { q:'Сколько стоит сайт?', a:'Лендинг — от 115 000 ₽, мультистраничный — от 175 000 ₽. Точную стоимость обсуждаем на созвоне — она зависит от объёма и задачи.' },
  ...
  { q:'Используете ли вы серые методы привлечения клиентов?', a:'Нет, и принципиально. Под серыми методами мы понимаем: спам-рассылки по купленным базам, холодный обзвон без согласия, накрутку отзывов и поведенческих факторов, парсинг контактов и агрессивные pop-up воронки. Всё это даёт краткосрочный результат и убивает репутацию бизнеса в долгую. Наша работа строится на том, чтобы к вам приходили люди, которым действительно нужен ваш продукт — через рекламу, SEO и сильный сайт.' },
]
