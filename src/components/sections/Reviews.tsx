...
const reviews = [
  { name:'Марина К.',   role:'Служба дезинфекции участков',  text:'Разработали промо-сайт и запустили рекламу точно к началу сезона. Поток звонков пошел сразу, причем клиенты целевые — с большими участками. Очень довольны подходом.', avatar: '/avatars/avatar2.jpg' },
  { name:'Алексей Н.',  role:'Производство шкафов автоматики',        text:'У нас сложный B2B-продукт, другие агентства не могли вникнуть в техническую часть. Здесь ребята сами разобрались в спецификациях, написали грамотные тексты и привели крупных промышленных заказчиков.', avatar: '/avatars/avatar1.jpg' },
  { name:'Ольга В.',    role:'Аварийная клининговая служба',            text:'Запустили контекстную рекламу на уборку помещений после ЧП. Звонки пошли в первые же дни. Отдельное спасибо за честность с бюджетами — платим Яндексу напрямую, расходы полностью прозрачны.', avatar: '/avatars/avatar3.jpg' },
]
