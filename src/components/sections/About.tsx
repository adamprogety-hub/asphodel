      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto', display: 'grid', gridTemplateColumns: '380px 1fr', gap: '60px', alignItems: 'start' }} className="about-grid">
        ...
        <div ref={refLeft} data-rv="up">
          ...
          <p style={{ fontFamily:'var(--ff-b)', fontWeight:400, fontSize:'14px', color:'#777', lineHeight:1.78, marginBottom:'28px' }}>
            Нас двое — Илья и Александр. Мы делаем сайты, которые не нужно «лечить» каждые полгода — без уязвимых CMS и случайных плагинов. И настраиваем рекламу так, чтобы вы понимали за что платите и как это работает.
          </p>
          <LiquidButton
            variant="dark"
            onClick={() => openModal({
