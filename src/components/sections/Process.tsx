...
const steps = [
  ...
  { n:'02', title:'Предложение и смета',        desc:'Через 1–2 дня: что делаем, сколько стоит, когда готово. Всё фиксируем в договоре.' },
  { n:'03', title:'Работа по этапам',           desc:'Каждый этап — согласование. Правки включены, итог по договору.' },
  { n:'04', title:'Сдача и обучение',           desc:'Передаём сайт с инструкцией. Первые 2 недели на связи — отвечаем на любые вопросы, пока всё не станет понятным.' },
]
