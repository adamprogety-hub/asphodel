...
export default function AIChatWidget() {
  ...
  const getAIReply = (query: string): string => {
    ...
    return 'Интересный вопрос! Мы в V.R. Asphodel делаем премиальные сайты на Next.js/React и настраиваем эффективный трафик в Яндекс.Директ. Хотите, созвонимся на 15 минут для бесплатной консультации? Просто напишите «да» или «хочу консультацию».'
  }
